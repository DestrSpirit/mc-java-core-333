...
class NeoForgeMC extends events_1.EventEmitter {
    ...
    async downloadInstaller(Loader) {
        ...
        const legacyMetaData = await (0, node_fetch_1.default)(Loader.legacyMetaData).then(res => res.json());
        const metaData = await (0, node_fetch_1.default)(Loader.metaData).then(res => res.json());
