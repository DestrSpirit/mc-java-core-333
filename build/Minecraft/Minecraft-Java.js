...
class JavaDownloader extends events_1.default {
    ...
    async getJavaFiles(jsonversion) {
        ...
        const javaVersionsJson = await (0, node_fetch_1.default)('https://launchermeta.mojang.com/v1/products/java-runtime/' +
            '2ec0cc96c44e5a76b9c8b7c39df7210883d12871/all.json').then(res => res.json());
