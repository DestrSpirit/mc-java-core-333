...
class Json {
    ...
    async GetInfoVersion() {
        ...
        const response = await (0, node_fetch_1.default)(`https://launchermeta.mojang.com/mc/game/version_manifest_v2.json?_t=${new Date().toISOString()}`);
        ...
        const jsonResponse = await (0, node_fetch_1.default)(matchedVersion.url);
