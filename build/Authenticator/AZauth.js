...
class AZauth {
    ...
    async login(username, password, A2F = null) {
        const response = await (0, node_fetch_1.default)(`${this.url}/authenticate`, {
            method: 'POST',
     ...
     */
    async verify(user) {
        const response = await (0, node_fetch_1.default)(`${this.url}/verify`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
     ...
     */
    async signout(user) {
        const response = await (0, node_fetch_1.default)(`${this.url}/logout`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                access_token: user.access_token
